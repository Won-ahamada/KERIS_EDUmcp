...
`;
  ...
  try {
    ...
    // 중첩 경로 테스트
    console.log('\n4. 중첩 경로 확인:');
    console.log('endpoints:', Object.keys((parsed as any).endpoints || {}));
    console.log('endpoints.student:', (parsed as any).endpoints?.student);
    console.log('endpoints.teacher:', (parsed as any).endpoints?.teacher);
